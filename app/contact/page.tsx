        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <a
              ...
              className="card p-8 text-center hover:border-gold border-2 border-transparent transition-colors"
            >
              ...
              <span className="text-gold font-medium">{defaultSettings.email}</span>
            </a>
            ...
            <div className="card p-8 text-center">
              ...
              <span className="text-teal font-medium">Shipping Worldwide</span>
            </div>
          </div>
        </div>
      </section>
