...
export default function Footer() {
  ...
  return (
    <footer className="bg-burgundy text-cream relative overflow-hidden">
      {/* Decorative pattern */}
      ...
      <div className="container-editorial py-20 md:py-24 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-cream/70 text-sm leading-relaxed max-w-sm mb-8">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="w-12 h-12 flex items-center justify-center border-2 border-cream/20 text-cream/70 hover:text-cream hover:border-gold hover:bg-gold/10 transition-all duration-300"
                aria-label="WhatsApp"
              >
          ...
          <div className="lg:col-span-3 lg:col-start-7">
            <h4 className="text-xs uppercase tracking-[0.3em] text-gold mb-6 font-semibold">
              Shop
            </h4>
