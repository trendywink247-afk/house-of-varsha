...
export default function Footer() {
  ...
  const footerLinks = {
    shop: [
      ...
      { label: 'Kurti Sets', href: '/shop?category=Kurti+Set' },
  ...
  return (
    <footer className="bg-soft-cream text-soft-black">
      {/* Main Footer */}
      <div className="container-editorial py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="w-10 h-10 flex items-center justify-center border border-light-gray text-muted-gray hover:text-soft-black hover:border-soft-black transition-all duration-300"
                aria-label="WhatsApp"
              >
          ...
          <div className="lg:col-span-3 lg:col-start-7">
            <h4 className="text-caption uppercase tracking-[0.2em] text-muted-gray mb-6 font-medium">
              Shop
            </h4>
            <ul className="space-y-3">
              {footerLinks.shop.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-body-sm text-warm-gray hover:text-soft-black transition-colors duration-300"
                  >
                    {link.label}
                  </Link>
                </li>
      ...
      <div className="border-t border-sand">
        <div className="container-editorial py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-caption text-light-gray">
