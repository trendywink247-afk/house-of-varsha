...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: '₹699',
    description: 'Elegant 3-piece Kurti set in sophisticated grey shade. Perfect blend of comfort and style for the modern woman.',
    category: 'Kurti Set',
    sizes: ['M', 'L', 'XL', 'XXL'],
    color: 'Grey',
    code: 'V005',
...
export const getProductsByCategory = (category: string) => {
  ...
  return products.filter(p => p.category.toLowerCase().replace(' ', '-') === category);
};
